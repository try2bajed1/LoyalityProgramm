 ...
 * Time: 17:00
 */
public class CardsActiveState implements IState {


    private final StatesActivity activity;

    public CardsActiveState(StatesActivity activity) {
    ...
    public void updateActionBarMenu() {
        activity.menu.findItem(R.id.action_add_card).setVisible(true);
