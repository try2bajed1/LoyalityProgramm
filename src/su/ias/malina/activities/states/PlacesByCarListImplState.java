 ...
 * Time: 17:00
 */
public class PlacesByCarListImplState implements IState {

    private final StatesActivity activity;

    public PlacesByCarListImplState(StatesActivity activity) {
    ...
    public void setPlacesByCarListImpl() {
        ...
        activity.loadListFrameForPoints(StatesActivity.CAR_LIST_STATE);
    }
